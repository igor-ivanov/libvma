 ...
 * How to use:
 *
 * ./testbed.out --receiver         --scount=20 --rcount=10 --msg-size=500 --msg-rate=2000 -d4 -n8000
 * ./testbed.out --engine=10.0.0.9  --scount=20 --rcount=10 --msg-size=500 --msg-rate=2000 -d4 -n8000
 * ./testbed.out --sender=10.0.0.10 --scount=20 --rcount=10 --msg-size=500 --msg-rate=2000 -d4 -n8000
 */
